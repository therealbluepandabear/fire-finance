...
export function shouldShowDefaultValue(key: keyof PlanEngineInputs): boolean {
    if (localStorage.getItem(rawInputsKey)) {
...
export function globalOnInput(e: React.FormEvent<HTMLInputElement>, percentage: boolean = false): void {
