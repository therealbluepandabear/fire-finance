...
//     expect(outputs.summary.fireAge).toBe(33)

//     expect(Math.floor(outputs.data[2].networth)).toBe(82_800)
//     expect(Math.floor(outputs.data[7].networth)).toBe(346_160)
//     expect(Math.floor(outputs.data[4].networth)).toBe(177_597)
//     expect(Math.floor(outputs.data[13].networth)).toBe(805_625)

//     expect(outputs.summary.fireNumber).toBe(750_000)
// })
...
//     expect(outputs.summary.fireAge).toBe(67)

//     expect(Math.floor(outputs.data[3].networth)).toBe(55_027)
//     expect(Math.floor(outputs.data[9].networth)).toBe(267_155)
//     expect(Math.floor(outputs.data[16].networth)).toBe(732_380)
//     expect(Math.floor(outputs.data[12].networth)).toBe(434_056)

//     expect(outputs.summary.fireNumber).toBe(2_125_000)
// })
...
//     expect(outputs.summary.retirementAge).toBe(21)
//     expect(Math.floor(outputs.data[14].networth)).toBe(265_106)
//     expect(Math.floor(outputs.data[16].networth)).toBe(308_330)
//     expect(Math.floor(outputs.data[10].networth)).toBe(182_977)
//     expect(Math.floor(outputs.data[27].networth)).toBe(575_325)

//     const maxNetworth = Math.max(...outputs.data.map((value) => value.networth))

//     expect(Math.floor(maxNetworth)).toBe(775_119)

//     const maxPoint = outputs.data[outputs.data.findIndex((value) => value.networth === maxNetworth)]
    
//     expect(maxPoint.age).toBe(50)
//     expect(maxPoint.year).toBe(2057)

//     expect(outputs.data.length).toBe(35)
// })
...
//     const rowIndex = outputs.summary.fireAge - (outputs.data[0].age) + 2
